...
} catch (InvalidPixCodeException $e) { /** Retorna que o código pix é inválido. */
} catch (CannotParseKeyTypeException $e) { /** Não foi possível determinar o tipo da chave pix. */
}
