...
if (empty($keyType)
        || empty($key)) { /** Retorna para o usuário que a chave é obrigatória */
}
...
try {
    ...
    // Continue o código...
} catch (InvalidPixKeyTypeException $e) { /** Retorna para o usuário que tipo da chave está inválido... */
} catch (InvalidPixKeyException $e) { /** Retorna para o usuário que a chave está inválida... */
}
