...
class Cob
{
     ...
     * @since 2.0.0
     */
    public const STATUS_UNSET = 'NAO_SETADO';
     ...
     * @since 2.0.0
     */
    public const STATUS_FINISHED = 'CONCLUIDA';
     ...
     * @since 2.0.0
     */
    public const STATUS_REMOVED_BY_RECEPTOR = 'REMOVIDA_PELO_USUARIO_RECEBEDOR';
     ...
     * @since 2.0.0
     */
    public const STATUS_REMOVED_BY_PSP = 'REMOVIDA_PELO_PSP';
