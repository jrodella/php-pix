...
class DueAmountModality
{
     ...
     * @since 2.0.0
     */
    public const MODALITY_REDUCTION = 'abatimento';
     ...
     * @since 2.0.0
     */
    public const MODALITY_FEE = 'juros';
     ...
     * @since 2.0.0
     */
    public const MODALITY_DISCOUNT = 'desconto';
     ...
     * @since 2.0.0
     */
    public const MODALITY_BANKFINE = 'multa';
     ...
     * @since 2.0.0
     */
    public const REDUCTION_MODALITY_FIXED = 1;
     ...
     * @since 2.0.0
     */
    public const REDUCTION_MODALITY_PERCENTAGE = 2;
     ...
     * @since 2.0.0
     */
    public const REDUCTION_MODALITIES = [1, 2];
     ...
     * @since 2.0.0
     */
    public const FEE_MODALITY_FIXED_REGULAR_CALENDAR = 1;
     ...
     * @since 2.0.0
     */
    public const FEE_MODALITY_FIXED_BUSINESS_CALENDAR = 5;
     ...
     * @since 2.0.0
     */
    public const FEE_MODALITY_PERCENTAGE_BY_DAY_REGULAR_CALENDAR = 2;
     ...
     * @since 2.0.0
     */
    public const FEE_MODALITY_PERCENTAGE_BY_MONTH_REGULAR_CALENDAR = 3;
     ...
     * @since 2.0.0
     */
    public const FEE_MODALITY_PERCENTAGE_BY_YEAR_REGULAR_CALENDAR = 4;
     ...
     * @since 2.0.0
     */
    public const FEE_MODALITY_PERCENTAGE_BY_DAY_BUSINESS_CALENDAR = 6;
     ...
     * @since 2.0.0
     */
    public const FEE_MODALITY_PERCENTAGE_BY_MONTH_BUSINESS_CALENDAR = 7;
     ...
     * @since 2.0.0
     */
    public const FEE_MODALITY_PERCENTAGE_BY_YEAR_BUSINESS_CALENDAR = 8;
     ...
     * @since 2.0.0
     */
    public const FEE_MODALITIES = [1, 2, 3, 4, 5, 6, 7, 8];
     ...
     * @since 2.0.0
     */
    public const DISCOUNT_MODALITY_FIXED = 1;
     ...
     * @since 2.0.0
     */
    public const DISCOUNT_MODALITY_FIXED_REGULAR_CALENDAR = 3;
     ...
     * @since 2.0.0
     */
    public const DISCOUNT_MODALITY_FIXED_BUSINESS_CALENDAR = 4;
     ...
     * @since 2.0.0
     */
    public const DISCOUNT_MODALITY_PERCENTAGE = 2;
     ...
     * @since 2.0.0
     */
    public const DISCOUNT_MODALITY_PERCENTAGE_REGULAR_CALENDAR = 5;
     ...
     * @since 2.0.0
     */
    public const DISCOUNT_MODALITY_PERCENTAGE_BUSINESS_CALENDAR = 6;
     ...
     * @since 2.0.0
     */
    public const DISCOUNT_MODALITIES = [1, 2, 3, 4, 5, 6,];
     ...
     * @since 2.0.0
     */
    public const BANKFINE_MODALITY_FIXED = 1;
     ...
     * @since 2.0.0
     */
    public const BANKFINE_MODALITY_PERCENTAGE = 2;
     ...
     * @since 2.0.0
     */
    public const BANKFINE_MODALITIES = [1, 2];
